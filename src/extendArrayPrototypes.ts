...
declare global {
  interface Array<T> {
    ...
    removeUntil(fn: (element: any, index: number, arr: any[]) => any): any[]
  }
}
Array.prototype.removeUntil =
  Array.prototype.removeUntil ??
  function <T>(this: T[], fn: (element: T, index: number, arr: T[]) => any): T[] {
    return arrayMethods.removeUntil(this, fn);
  };
